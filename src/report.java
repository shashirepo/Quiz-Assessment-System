...
public class report implements PdfPageEvent{
  private static String FILE = "WebContent/admin/reports/FirstPdf.pdf";
  ...
  public report()
  {
	  ...
	  try {
	//waterMark=Image.getInstance("WebContent/admin/pics/logo.png");
	      Document document = new Document();
	    PdfWriter writer= PdfWriter.getInstance(document, new FileOutputStream(FILE));
	      document.open();
	     
		//  writer.setPageEvent( new report() );
  ...
  private static void addMetaData(Document document) {
    document.addTitle("Report for Quiz:");
    document.addSubject("Quiz on ");
